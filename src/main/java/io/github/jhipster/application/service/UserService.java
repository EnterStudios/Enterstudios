...
public class UserService {
    ...
    public UserDTO getUserFromAuthentication(OAuth2Authentication authentication) {
        ...
        Set<String> userAuthorities = extractAuthorities(authentication, details);
    ...
    @SuppressWarnings("unchecked")
    private static Set<String> extractAuthorities(OAuth2Authentication authentication, Map<String, Object> details) {
    ...
    private static Set<String> extractAuthorities(List<String> values) {
        return authoritiesFromStringStream(
            values.stream().filter(role -> role.startsWith("ROLE_"))
        );
    }

    private static Set<String> authoritiesFromStringStream(Stream<String> strings) {
